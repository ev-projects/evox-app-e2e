...
class RequestListLoadBranchTest extends TestCase
{
    ...
    {
        $this->bindMock(OvertimeRepositoryInterface::class)->shouldReceive('where')->once()->andReturn([]);
    ...
    {
        $this->bindMock(OvertimeRepositoryInterface::class)->shouldReceive('where')->once()
    ...
    {
        $this->bindMock(OvertimeRepositoryInterface::class)->shouldReceive('where')->once()->andReturn([]);
        $this->bindMock(AlterLogRepositoryInterface::class)->shouldReceive('where')->once()->andReturn([]);
        $this->bindMock(RestDayWorkRepositoryInterface::class)->shouldReceive('where')->once()->andReturn([]);
        $this->bindMock(ChangeScheduleRepositoryInterface::class)->shouldReceive('where')->once()->andReturn([]);
        $this->bindMock(AlterLogPunchRepositoryInterface::class)->shouldReceive('where')->once()->andReturn([]);
    ...
    {
        $this->bindMock(RequestRepositoryInterface::class)->shouldReceive('get_status_numbers_only')->once()
             ->andReturn(['pending' => 0]);
