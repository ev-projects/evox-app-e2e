...
return [
    ...
    */
    ...
    'connections' => [
        ...
        'drupal_portal' => [
            'driver' => 'mysql',
            'host' => env('DRUPAL_EVOX_DB_HOST', '127.0.0.1'),
            'port' => env('DRUPAL_EVOX_DB_PORT', '3306'),
            'database' => env('DRUPAL_EVOX_PORTAL_DB_DATABASE', 'forge'),
            'username' => env('DRUPAL_EVOX_DB_USERNAME', 'forge'),
            'password' => env('DRUPAL_EVOX_DB_PASSWORD', ''),
            'unix_socket' => env('DB_SOCKET', ''),
            'charset' => 'utf8mb4',
            'collation' => 'utf8mb4_unicode_ci',
            'prefix' => '',
        ...
        'drupal_payroll' => [
            ...
            'host' => env('DRUPAL_EVOX_DB_HOST', '127.0.0.1'),
            'port' => env('DRUPAL_EVOX_DB_PORT', '3306'),
            'database' => env('DRUPAL_EVOX_PAYROLL_DB_DATABASE', 'forge'),
            'username' => env('DRUPAL_EVOX_DB_USERNAME', 'forge'),
            'password' => env('DRUPAL_EVOX_DB_PASSWORD', ''),
            'unix_socket' => env('DB_SOCKET', ''),
            'charset' => 'utf8mb4',
