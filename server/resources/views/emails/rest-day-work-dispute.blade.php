    ...
    <div style="width:600px;margin:0 auto 0 auto;background:#fff;border: 1px solid #8fd400;font-family:BhrHeaderFont,Trebuchet MS;">
      <div>
        <div style="height: 50px;background-color: #A0CD32;">
          <h1 style="font-weight:normal;font-size:1.5em;text-align:center;color:white;padding-top:11px;margin:0px;">Payroll Dispute for {{ slug_to_text( get_constant('REQUEST_TYPES.rest_day_work')) }}</h1>
        </div>
        ...
        <div style="padding: 0px 25px 10px 25px;">
          ...
          <p>Payroll dispute for rest day on the selected dates below:</p>
        </div>
        <div style="padding: 0px 25px 0px 25px;">
          <table width="100%" style="margin-left:auto;margin-right:auto;">
            ...
            <tr ><td colspan="4" style="padding:5px 10px;background-color: #E6E6E6;">Request Date: <strong>{{ date_to_text($request['date'], 'D, d M Y') }}</strong></td><tr>
