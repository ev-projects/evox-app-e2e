    ...
    <div style="width:600px;margin:0 auto 0 auto;background:#fff;border: 1px solid #8fd400;font-family:BhrHeaderFont,Trebuchet MS;">
      <div>
        <div style="height: 50px;background-color: #A0CD32;">
          {{-- <h1 style="font-weight:normal;font-size:1.5em;text-align:center;color:white;padding-top:11px;margin:0px;">Reminder for {{ slug_to_text( get_constant('REMINDER_TYPE.requests')) }}</h1> --}}
          <h1 style="font-weight:normal;font-size:1.5em;text-align:center;color:white;padding-top:11px;margin:0px;">Reminder regarding employees with pending requests</h1>
        ...
        <div style="padding: 0px 25px 10px 25px;">
          ...
          <p>Listed below are employees with pending requests:</p>
        </div>
        <div style="padding: 0px 25px 0px 25px;">
          <table width="100%" style="margin-left:auto;margin-right:auto;">
              ...
              @foreach($pending_requests as $employee)
                <tr>
