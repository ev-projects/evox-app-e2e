...
class GenerateFeaturesToLevel extends Migration
{
    ...
    $login->features_level()->attach([0,1,2,3,4,5,6,8]);

    $dtr_access = Features::create([ 'feature_name' =>"dtr_access", 'feature_label'=>"DTR Access"]);
    $dtr_access->features_level()->attach([0,1,2,3,4,5,6,8]);
    ...
    $view_employee_personal_information->features_level()->attach([1,2,3,4,5,6,8]);
    ...
    $view_employee_job_information->features_level()->attach([1,2,3,4,5,6,8]);
    ...
    $view_whos_out->features_level()->attach([1,2,3,4,5,6,8]);

    $view_holidays = Features::create([ 'feature_name' =>"view_holidays", 'feature_label'=>"View Holidays"]);
    $view_holidays->features_level()->attach([0,1,2,3,4,5,6,7,8]);
    ...
    $manage_ops = Features::create([ 'feature_name' =>"manage_ops", 'feature_label'=>"Manage Ops*"]);
    //  $manage_ops->features_level()->attach([0,1,2,3,4,5,6]); this is null be default
