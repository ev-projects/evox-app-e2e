...
class BhrRepository implements BhrRepositoryInterface{
    ...
    {
        log_to_file( 'info', get_constant('LOG_START') . __FUNCTION__ , [ 'start_date' => $start_date, 'end_date' => $end_date, 'user' => $user], "bhr-leaves");
        try {
            ...
            log_to_file( 'info', get_constant('LOG_END') . __FUNCTION__ , $bhr_leaves_array, "bhr-leaves");
            log_to_file( 'info', get_constant('LOG_GAP'), [], "bhr-leaves");
            ...
            log_error($e);
            log_to_file( 'info', get_constant('LOG_END') . __FUNCTION__ , [], "bhr-leaves");
            log_to_file( 'info', get_constant('LOG_GAP'), [], "bhr-leaves");
