...
class SupervisorReminderRequestsEmail extends Mailable
{
    ...
    {   
        ...
        $this->pending_requests = $reminder[1];
    ...
    public function build()
    {
        ...
        $this->subject( "Reminder for Employees with Pending Requests" )
             ->markdown('emails.reminders.requests-reminder');
