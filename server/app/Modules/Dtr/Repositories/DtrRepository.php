            ...
            foreach( $user_collection as $user ) {
                ...
                foreach( $date_array as $date) {
                    ...
                    $dtr_insert_values =  [
                        'user_id'               => "'".$user->id."'",
                        'date'                  => "'".$date."'",
                        'start_datetime'        =>  ( is_valid($parsed_schedule_detail) ) ? $parsed_schedule_detail['start_datetime'] : 'null',
                        'end_datetime'          =>  ( is_valid($parsed_schedule_detail) ) ? $parsed_schedule_detail['end_datetime'] : 'null',
                        'start_flexy_datetime'  =>  ( is_valid($parsed_schedule_detail) ) ? $parsed_schedule_detail['start_flexy_datetime'] : 'null',
                        'end_flexy_datetime'    =>  ( is_valid($parsed_schedule_detail) ) ? $parsed_schedule_detail['end_flexy_datetime'] : 'null',
                        'break_time'            =>  ( is_valid($parsed_schedule_detail) ) ? $parsed_schedule_detail['break_time'] : 'null',
