            ...
            foreach ($dtr_records as $dtr_record) {
                ...
                $result[] =  array_merge( 
                    array(
                        ...
                        'time_in' => timestamp_to_datetime( $dtr_record->time_in, false, $owner ),
                        'time_out' => timestamp_to_datetime( $dtr_record->time_out, false, $owner ),
                        'start_datetime' => timestamp_to_datetime( $dtr_record->start_datetime, false, $owner ),
                        'end_datetime' => timestamp_to_datetime( $dtr_record->end_datetime, false, $owner ),
                        'start_flexy_datetime' => timestamp_to_datetime( $dtr_record->start_flexy_datetime, false, $owner ),
                        'end_flexy_datetime' => timestamp_to_datetime( $dtr_record->end_flexy_datetime, false, $owner ),
