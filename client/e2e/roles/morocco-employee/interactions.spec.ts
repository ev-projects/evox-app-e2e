// Interaction spec — role: morocco-employee (mariam.elmakrini@unit-t.eastvantage.com)
...
// =============================================================================
test.describe('Daily Time Record — India/Morocco variant (/app/dtr_in_mar/4263/)', () => {
  test('"Daily Time Record" heading is visible ⚠️', async ({ page }) => {
    ...
    await page.goto('/app/dtr_in_mar/4263/');
