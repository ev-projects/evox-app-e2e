// AUTO-GENERATED from live menu dump 2026-07-08 — role: admin (dummyman@ops.eastvantage.com)
...
const MENU: Array<{ label: string; href: string }> = [
  ...
  },
  {
    ...
    "href": "/app/admin/SyncBiometrics/"
  },
  {
    "label": "Sync > BHR User Updates",
    "href": "/app/admin/SyncUserUpdates/"
  },
  {
    "label": "Sync > BHR Leaves",
    "href": "/app/admin/SyncBhrLeaves/"
  },
  {
    "label": "Sync > UTC Sync",
    "href": "/app/admin/SyncUTCAdjustment/"
  },
  {
    "label": "Assign > Assign Sub-Department",
    "href": "/app/admin/AssignSubDepartment/"
  },
  {
    "label": "Assign > Feature Management",
    "href": "/app/admin/AssignFeature/"
  },
  {
    "label": "Admin Functions > Careers",
    "href": "/app/admin/CareersImport/"
  },
  {
    "label": "Admin Functions > Payroll Cutoff",
    "href": "/app/admin/PayrollCutoff/"
  },
  {
    "label": "Admin Functions > Generate Date",
    "href": "/app/admin/GenerateDate/"
  },
  {
    "label": "Admin Functions > EVOX Updates",
    "href": "/app/admin/ManageChangeLogs/"
  },
  {
    "label": "Admin Functions > Department List",
    "href": "/app/admin/DepartmentList/"
  }
];

test.describe('admin — menu traversal (40 pages)', () => {
