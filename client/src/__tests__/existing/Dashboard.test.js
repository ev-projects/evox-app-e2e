...
// NOTE (2026-07-27 run fix): Dashboard.js imports the DIRECTORY '../../components/Dashboard/
// EmployeeDashboard' (index resolution), so the old EmployeeDashboard.js-file mock never
// applied and the real child tree loaded -> "Element type is invalid ... got: undefined".
// Mock the exact specifiers Dashboard.js uses:
jest.mock('../../components/Dashboard/EmployeeDashboard', () =>
    () => <div data-testid="employee-dashboard">EmployeeDashboard</div>
);
jest.mock('../../components/Dashboard/HandlerDashboard', () =>
    () => <div data-testid="handler-dashboard">HandlerDashboard</div>
);
jest.mock('../../components/Summary/SummaryDashbord', () =>
    () => <div data-testid="summary-dashboard">SummaryDashbord</div>
);
...
// react-player/lazy is ESM (untranspiled by react-scripts 3.3.0) — same fix as EmployeeDashboard.test.js
jest.mock('react-player/lazy', () => () => null);
// ThemeConsumer must be a render-prop component regardless of the installed styled-components version
jest.mock('styled-components', () => ({
    ...jest.requireActual('styled-components'),
    ThemeConsumer: ({ children }) => (typeof children === 'function' ? children({}) : children),
}));
