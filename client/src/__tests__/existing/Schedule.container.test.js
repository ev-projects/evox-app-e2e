...
// ---------------------------------------------------------------------------
// All Schedule sub-components are named exports of ScheduleDetails.js
jest.mock('../../components/Schedule/ScheduleDetails.js', () => ({
    Scheduledetails:                    () => <div data-testid="schedule-details" />,
    ScheduledetailsWithTimezone:        () => <div data-testid="schedule-details-tz" />,
    ...
    StandardSchedDetailsFormWithTimezone:  () => <div data-testid="standard-form-tz" />,
    FlexibleSchedDetailsFormWithTimezone:  () => <div data-testid="flexible-form-tz" />,
...
describe('Schedule — ScheduleAssign (User) component', () => {
    ...
    test.skip('skipped — form only renders after isInitialDataLoaded=true (set in componentWillReceiveProps, requires Redux dispatch)', () => {
    ...
    test.skip('skipped — WorkDays is inside the Formik form which only renders after isInitialDataLoaded=true (requires Redux dispatch)', () => {
