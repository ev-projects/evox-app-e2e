...
// DisputeReport builds a <Link> to global.links.payroll_dispute when a dispute row
// is rendered. That global is injected at app runtime; provide it for the test env.
global.links = { ...(global.links || {}), payroll_dispute: '/payroll-dispute/' };
