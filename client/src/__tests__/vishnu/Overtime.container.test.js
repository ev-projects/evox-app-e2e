...
// ---------------------------------------------------------------------------
// PageLoading stub — Overtime.js imports from "../../PageLoading"
// Resolved from component: src/container/Request/Overtime/ → src/container/PageLoading
// Mocked here relative to test file (src/__tests__/containers/):
// ---------------------------------------------------------------------------
...
const defaultProps = {
    ...
    match:    { params: {} },
    params:   {},                   // component reads this.props.params directly
    location: { search: '' },
...
describe('Overtime component', () => {
    ...
    test('clearOvertimeInstance is called on component mount (view mode)', () => {
        renderComponent({ match: { params: { id: '10' } }, params: { id: '10' } });
        expect(defaultProps.clearOvertimeInstance).toHaveBeenCalled();
    });
    ...
    test('fetchOvertime is NOT called when no id param (store mode)', () => {
        renderComponent({ match: { params: {} }, params: {} });
