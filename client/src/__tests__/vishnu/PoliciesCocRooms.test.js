...
// PoliciesDocumentModal imports Modal from 'react-bootstrap/Modal' (not react-modal, which
// isn't installed). Stub that instead so the modal renders without portals.
...
const defaultRoomMasterProps = {
    ...
    history:      { push: jest.fn() },
    match:        { params: { id: '0' } },
    params:       { id: '0' },   // RoomMaster reads props.params.id directly (not match.params)
    location:     { search: '' },
    roomdetails:  null,
    locationlist: [],
    isLoading:    false,
