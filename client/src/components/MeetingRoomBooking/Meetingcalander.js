      ...
      API.call({
        ...
        .then((response) => {
          if (response.data.status === "200") {
            ...
            if (hours <= 3) {
              event.push({
                title: roomname +" Booked by "+ user.first_name + " "+ user.last_name,
      ...
      API.call({
        ...
        .then((response) => {
          for (var i = 0; i < response.data.length; i++) {
            ...
            event.push({
              title: response.data[i].name + " Booked By " + response.data[i].first_name +" "+response.data[i].last_name,
    ...
    const handleClose = () => {
      ...
      const calendar = new Calendar(calendarEl, {
        ...
        eventMouseEnter: function(arg){
          ...
          let endtime = endDT.substring(16, 21);
          tippy(arg.el, {
            content: "StartTime: " + starttime +"  EndTime: " + endtime + " <br> " + arg.event.title,
            // animation:true,
            allowHTML:true,
            theme:'light'
